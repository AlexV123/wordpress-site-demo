...
/*Sidebar Layout*/
$wp_customize->add_setting( 'prolific_theme_options[prolific-sidebar-layout]', array(
    'capability'		=> 'edit_theme_options',
    'default'			=> $defaults['prolific-sidebar-layout'],
    'sanitize_callback' => 'prolific_sanitize_select'
) );
$choices = prolific_sidebar_layout();
$wp_customize->add_control( 'prolific_theme_options[prolific-sidebar-layout]', array(
    'choices'  	=> $choices,
    ...
    'settings'  => 'prolific_theme_options[prolific-sidebar-layout]',
    'type'	  	=> 'select'
) );