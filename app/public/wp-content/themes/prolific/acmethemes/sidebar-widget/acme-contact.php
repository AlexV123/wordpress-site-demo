...
if (!class_exists('Prolific_contact')) {
    ...
    class Prolific_contact extends WP_Widget {
        ...
        public function form($instance) {
            ...
            <p>
                <label for="<?php echo $this->get_field_id('shortcode'); ?>"><?php _e('Enter Shortcode', 'prolific'); ?>
                    :</label>
            ...
            <p>
                ...
                <textarea class="widefat" rows="5" cols="15" id="<?php echo $this->get_field_id('map'); ?>"
                          name="<?php echo $this->get_field_name('map'); ?>"><?php echo $map; ?></textarea>
            </p>
            <p>
                <label
                    for="<?php echo $this->get_field_id('page_id'); ?>"><?php _e('Select Page For Contact', 'prolific'); ?>
                    :</label>
                <br/>
